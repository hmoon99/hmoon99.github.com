    ...
    'use strict';
      ...
      myForm.addEventListener('submit', function(event){
          ...
          if(name && noun1 && noun2 && noun3 && adj1 && adj2 && adj3&& verb && beverage && adverb){
              myText = `Hello ${name}! Spring is a time of renewal, rebirth, and ${noun1}. You should plant a ${noun2}. Summer is the warmest time of year. ${verb} to the beach. It would be so ${adj1}. Autumn is when the leaves ${adverb} fall from the trees. Halloween is celebrated and you will dress upas a ${noun3}. Winter is cold and ${adj2}. You can drink some hot ${beverage} , and open ${adj3} presents.`;
          }else{
